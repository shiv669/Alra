...
> = ({
  ...
  /**
   * Step 1: Auto-resize textarea based on content
   */
  React.useEffect(() => {
  ...
  /**
   * Step 2: Handle Enter key to submit
...
const VoiceRecorder: React.FC<VoiceRecorderProps> = ({
  ...
  /**
   * Step 1: Timer for recording duration
   */
  React.useEffect(() => {
    if (isRecording) {
      onStartRecording();
...
>(
  (
    ...
    /**
     * Step 1: Toggle features (only one can be active at a time)
     */
    ...
    /**
     * Step 2: Toggle canvas independently
     */
    const handleCanvasToggle = () => setShowCanvas((prev) => !prev);

    /**
     * Step 3: Check if file is image
     */
    ...
    /**
     * Step 6: Remove file from upload
     */
    ...
    /**
     * Step 7: Open image preview modal
     */
    const openImageModal = (imageUrl: string) => setSelectedImage(imageUrl);

    /**
     * Step 8: Handle paste to upload image
     */
    ...
    /**
     * Step 10: Voice recording handlers
     */
    ...
    /**
     * Step 11: Check if input has content
     */
